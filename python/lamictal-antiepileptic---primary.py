...
codes = [{"code":"dnfD.","system":"readv2"},{"code":"dnf4.","system":"readv2"},{"code":"dnfG.","system":"readv2"},{"code":"dnfH.","system":"readv2"},{"code":"dnfJ.","system":"readv2"},{"code":"dnfF.","system":"readv2"},{"code":"dnf9.","system":"readv2"}];
REQUIRED_CODES = 1;
